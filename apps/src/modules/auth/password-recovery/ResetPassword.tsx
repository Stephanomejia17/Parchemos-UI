...
import { ApiError, evaluatePassword } from "@/shared/auth";
        ...
        {completed ? (
          ...
          <>
            {error && (
              <div
                role="alert"
                className="flex gap-2.5 rounded-2xl bg-red-50 px-4 py-3 text-sm text-red-700"
              >
            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-4" noValidate>
              ...
              <label className="flex flex-col gap-1.5">
                <span className="text-xs font-semibold text-gray-600">Confirmar contraseña</span>
                <input
