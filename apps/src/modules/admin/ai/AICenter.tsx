...
export function AICenter() {
  ...
  return (
    <div className="space-y-5">
      <SectionHeader
        title="Centro de IA"
        sub="Insights automáticos, predicciones y asistente inteligente"
      />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-2">
        {aiInsights.map((ins, i) => (
          <Card key={i} className="p-4 flex items-start gap-3">
            <div
              className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 ${ins.color.split(" ").slice(1).join(" ")}`}
            >
