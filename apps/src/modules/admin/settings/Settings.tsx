...
import { SETTINGS_SECTIONS } from "@/mocks/admin/settings";
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {SETTINGS_SECTIONS.map((s) => (
          <Card
            key={s.title}
            className="p-5 hover:shadow-[0_4px_16px_rgba(0,0,0,0.07)] transition-all cursor-pointer group"
          >
            ...
            <button className="mt-4 text-[12px] font-medium text-[#FF6B35] hover:underline">
              Configurar →
            </button>
          </Card>
        ))}
