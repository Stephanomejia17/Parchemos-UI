...
import { pendingVerifications } from "@/mocks/admin/verification";
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 flex-wrap mb-4">
                  {v.docs.map((d) => (
                    <span
                      key={d}
                      className={`text-[11px] font-medium px-2.5 py-1 rounded-lg border ${d.includes("✓") ? "bg-emerald-50 text-emerald-700 border-emerald-100" : "bg-red-50 text-red-700 border-red-100"}`}
                    >
                ...
                <div className="flex items-center gap-2">
                  <button
                    className="flex items-center gap-1.5 px-3.5 py-2 text-[12px] font-semibold text-white rounded-xl transition-colors"
