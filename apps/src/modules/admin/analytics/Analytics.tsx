...
import { SurfaceCard as Card } from "@/shared/components";
...
import { cityRevData } from "@/mocks/admin/shared";
import { funnelSteps, retentionData } from "@/mocks/admin/analytics";
  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        ...
        sub="Métricas clave, retención, embudos y rendimiento"
      />
      ...
      <Card className="p-5">
        ...
        <p className="text-[12px] text-gray-500 mb-5">
          Registro → Descubrimiento → Reserva → Pedido → Pago
        </p>
        <div className="flex flex-col gap-2">
          {funnelSteps.map((step, i) => (
            <div key={step.label} className="flex items-center gap-4">
              ...
              <div
                className="w-10 text-left text-[12px] font-semibold"
                style={{ color: i === 0 ? ACCENT : "#6C757D" }}
              >
                {step.pct}%
              </div>
            </div>
